...
This guide applies to Redbeard Time Tracker 2.5.0. It covers the Home Assistant, Docker, and standalone versions; the features are the same in each installation.
